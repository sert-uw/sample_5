...
class SoftwaresControllerTest < ActionController::TestCase
  ...
  test "should create software" do
    assert_difference('Software.count') do
      post :create, software: { hard: @software.hard, maker: @software.maker, name: @software.name, price: @software.price }
    end
  ...
  test "should update software" do
    patch :update, id: @software, software: { hard: @software.hard, maker: @software.maker, name: @software.name, price: @software.price }
    assert_redirected_to software_path(assigns(:software))
  end
